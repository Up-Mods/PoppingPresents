...
public class PPEntities {
    ...
    public static final Supplier<EntityType<PresentEntity>> PRESENT = PPCommon.COMMON_PLATFORM.registerEntity("present", PresentEntity::new, MobCategory.MISC, builder -> builder
        .sized(0.5F, 0.7F)
